...
EXAMPLE = {
    "01-project-charter": {
        ...
        'Secondary': 'Median resolution time, in-scope billing adjustments | 4.6 h | 4.0 h | no operational definition — OD-BIL-007 v1 is registered nowhere in the pack',
        'Counter-balancing': 'CSAT, in-scope billing adjustments | 4.11 out of 5 | no decline greater than 0.15 | no operational definition — OD-CX-002 v3 is registered nowhere in the pack',
    ...
    "14-root-cause-evidence-pack": {
        ...
        "Practical threshold met?": "No. The threshold is 13.1 pts — what 11,592 adjustments must move to clear the $50,000 floor. Observed 4.9",
    ...
    "09-baseline-document": {
        'Normality assessment (probability plot, not just the p-value)': 'Probability plot linear across eleven weeks with the release week clear of the line; Anderson-Darling A\u00b2 = 0.81 on the twelve published rates, p = 0.02',
        ...
        'n': '61,400 tickets over the 12-week window (~5,100/week), week by week 6,400 \u00d7 4 in January, 4,947 \u00d7 3 across the pricing weeks from 1 February, then 4,192, 4,192, 4,192, 4,192 and 4,191 — the whole Billing queue, not the adjustment population',
        'Mean': '14.2%',
        '**Median**': '14.0%',
        # The twelve weekly rates live in this cell, because every other figure in
        # section 3 is computed from them and an SD with no series behind it is how
        # 1.4 points shipped -- a value no series can produce.
        'Standard deviation': '1.8 points, on the twelve weekly rates this section is cut on: 14.9, 14.7, 14.5, 14.3, 13.8, 14.0, 18.9, 14.0, 12.6, 12.5, 12.4 and 12.2 (%, w/c 2026-01-05 onward)',
        'p10 / p50 / p90 / p95': '12.4% / 14.0% / 14.9% / 16.7%',
        'Skewness': '1.56 — the moment coefficient m\u2083/m\u2082^1.5; Excel\u2019s SKEW() returns 1.79 on the same twelve numbers, so say which you used',
        'Distribution shape': 'Not symmetric: eleven weeks between 12.2% and 14.9% and one at 18.9%',
        'Index justification': 'Ppu — only an upper limit exists (target is a maximum)',
        '**Capability index value**': 'Ppu \u22121.15 — (8.0% \u2212 14.2%) \u00f7 (3 \u00d7 1.8 points)',
        '% outside specification (observed)': '100% — all 12 weeks sit above the 8.0% target',
        '% outside specification (fitted)': '>99.9%',
        ...
        "Chart type justification": "Proportion at ~5,100 tickets/week; sigma z = 2.08, so an ordinary p-chart is too tight — its limits would be 15.7% / 12.7%",
        "Centre line": "14.2%",
    },
    "16-pilot-protocol": {
        ...
        '**Practical significance threshold**': '13.1 percentage points on 11,592 in-scope adjustments — what it takes to clear the $50,000 floor, which is more than the whole 6.2-point gap',
        'Alpha': '0.05',
    ...
    "03-voc-ctq-tree": {
        ...
        '2': 'Do not make me chase it | The adjustment posts before I am told it is done | Share of in-scope adjustments confirmed posted before the case is closed | Not set — nothing in the pack measures this share yet | Not defined — no traced query exists | In-scope billing adjustments | Census',
        '3': 'Tell me when it will be resolved | A committed date given at first contact | Share of contacts with a commitment logged | >= 90% | QA audit item 7 | Sampled contacts | 200/week stratified',
        '4': 'Do not make me repeat myself | Resolved without a second contact | 7-day reopen rate, all billing tickets | No target — context only; the 8.0% belongs to the adjustment population | OD-BIL-004 v2 | All billing tickets | Census',
